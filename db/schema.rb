...
ActiveRecord::Schema.define(version: 2022_11_18_185121) do
  ...
  create_table "resenas", force: :cascade do |t|
    ...
    t.text "comentario"
    t.index ["publication_id"], name: "index_resenas_on_publication_id"
  ...
  add_foreign_key "resenas", "publications"
